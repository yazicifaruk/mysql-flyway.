create table customers(id bigint not null auto_increment,name varcahar(255),primary key(id));
...
create table phone_numbers(id bigint not null auto_increment,value varcahar(255),primary key(id));